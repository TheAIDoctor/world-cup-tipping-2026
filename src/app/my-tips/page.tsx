      ...
      select: {
        ...
        match: {
          select: {
            ...
            homeScore: true,
            awayScore: true,
            homeTeam: { select: { code: true, flagEmoji: true, group: true } },
            awayTeam: { select: { code: true, flagEmoji: true, group: true } },
          },
        },
      },
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex-1 min-w-0 space-y-0.5">
                        ...
                        <div className="flex items-center gap-2 text-sm font-semibold">
                          <span>{m.homeTeam?.flagEmoji ?? "❓"} {m.homeTeam?.code ?? "TBD"}</span>
                          <span className="tabular-nums font-extrabold text-base" style={{ color: "#ffcd57" }}>
                            {tip.homeScore}–{tip.awayScore}
                          </span>
                          <span>{m.awayTeam?.code ?? "TBD"} {m.awayTeam?.flagEmoji ?? "❓"}</span>
                        </div>
                        {played ? (
